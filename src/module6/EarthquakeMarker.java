...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	//TODO :Implement compareTo method of comparable interface
	...
	public void addKey2(PGraphics pg)
	{
		
		int x= EarthquakeCityMap.countcities(this);
		
		int xbase = 0;
		int ybase = 0;
		String str ="Earthquake Info : "+getTitle().substring(8) +", Mag "+getMagnitude()+", Dpt "+getDepth()+", Rad "+getRadius()+", Affects "+x+" cities ";
		pg.fill(255);
		pg.rect(xbase, ybase, 650, 20);
		pg.fill(0);
		//pg.textAlign(PConstants.LEFT, PConstants.CENTER);
		pg.textSize(12);
		pg.text(str,xbase+4, ybase+14);
